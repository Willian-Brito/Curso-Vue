<template>
    <v-toolbar app>
        <v-toolbar-title headline text-uppercase mr-4>
            <span>Stock</span>
            ...
            <v-menu offset-y>
                ...
                <v-list>
                    <v-list-tile @click="saveData">
                        <v-list-tile-title style="cursor: pointer">Salvar Dados</v-list-tile-title>
                    </v-list-tile>
                    <v-list-tile @click="loadDataLocal">
                        <v-list-tile-title style="cursor: pointer">Carregar Dados</v-list-tile-title>
                    </v-list-tile>
                </v-list>
            </v-menu>
